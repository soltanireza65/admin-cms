			...
			<div className="flex flex-1">
				...
				>
					...
					<FormControl className="w-1/6 ml-5">
						...
						>
							<MenuItem value={0}>{t('header_search_menu_titr')}</MenuItem>
							<MenuItem value={1}>{t('header_search_menu_newsCode')}</MenuItem>
						</Select>
					</FormControl>
